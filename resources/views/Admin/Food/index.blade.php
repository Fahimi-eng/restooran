...
@section('content')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a class="btn btn-primary m-5" href="{{ route('panel.food.create') }}"> غذای جدید</a>
    </div>

    <div class="d-flex flex-wrap">
        @foreach($foods as $food)
        <div class="card border mx-2 my-3" style="max-width: 19rem">
            <img src="{{ str_replace('public','/storage',$food->image) }}" class="card-img-top" alt="...">
            <div class="card-body">
